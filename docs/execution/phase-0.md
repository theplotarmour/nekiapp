...
| G05 / NK-GAP-05 | Open | Backend lead | Complete operation/schema/error matrix and reviewed OpenAPI for every §18 family. | P0; G08/G14/G25/G29 |
...
| G17 / NK-GAP-17 | Open | Backend | Reconcile pending Activity projection versus final append-only impact creation across TDD/schema/flows. | P0; G14 |
...
| G19 / NK-GAP-19 | Open | Backend + privacy | Specify immutable canonical payload, concurrent append, mutable identity, corrections/checkpoints. | P6; G17/G21 |
...
| G25 / NK-GAP-25 | Open | Security + Finance | Define scoped actions, reasons, step-up, separation of duties and revocation behavior. | P0–P1 |
...
| NK-DOC-4.01 | Operation inventory + authorization/error matrix for every §18 family; no implied unrestricted admin transitions. | Draft transitions + G25 | Backend / 2 days | Open |
| NK-DOC-4.02 | Reviewed OpenAPI schemas/examples, validation and generated-client workflow; reconcile TDD/schema references. | NK-DOC-4.01 | Backend / split after inventory | Open |
