...
| OpenAPI/errors/auth matrix | Partial: 324 operation rows spanning all 22 plan families, route/field policies and request/error profiles. Structural validator passes; typed OpenAPI, per-operation examples/errors/events, final grants and runtime checks missing. |
